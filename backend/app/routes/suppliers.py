    ...
    try:
        ...
        cur.execute(
            ...
            INSERT INTO suppliers
                (name, phone, email, contact_person, address, category, status)
            VALUES
                (%s, %s, %s, %s, %s, %s, %s)
            RETURNING
                id, name, phone, email, contact_person, address, category, status, created_at;
            """,
            (
                payload.name,
                payload.phone,
...
def update_supplier(supplier_id: int, payload: SupplierUpdate):
    ...
    try:
        ...
        allowed = {"name", "phone", "email", "contact_person", "address", "category", "status"}
        ...
        cur.execute(
            ...
            SET {set_clause}
            WHERE id = %s
            RETURNING id, name, phone, email, contact_person, address, category, status, created_at;
            """,
            values,
        )
        row = cur.fetchone()
