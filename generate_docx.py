...
def create_report():
    ...
    # Setup global styles (Arial 11pt)
    ...
    # Title
    heading = doc.add_heading('OptiWare Logistics Data Analysis Report', 0)
    heading.alignment = WD_ALIGN_PARAGRAPH.CENTER

    doc.add_paragraph('University of Information Technology').alignment = WD_ALIGN_PARAGRAPH.CENTER
    doc.add_paragraph('2025-2026 Academic year').alignment = WD_ALIGN_PARAGRAPH.CENTER
    doc.add_paragraph('CST-8316 Data Analysis and Management').alignment = WD_ALIGN_PARAGRAPH.CENTER
    
    # Project Member List
    doc.add_heading('Project Member List', level=2)
    doc.add_paragraph('1. TNT-0001 Mg Aung Aung\n2. TNT-0002 (To be filled)\n3. TNT-0003 (To be filled)\n4. TNT-0004 (To be filled)\n5. TNT-0005 (To be filled)')
    doc.add_page_break()
