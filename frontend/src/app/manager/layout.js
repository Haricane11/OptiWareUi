  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Receive", url: "/manager/receive", icon: ArrowDownCircle },
                    ...
                    <div key={index}>
                      {item.url ? (
                        <NavLink
                          ...
                          href={item.url}
                          className={cn(
                            "flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-sm transition-all duration-200",
                            isActive
                        ...
                        <button
                          ...
                          className={cn(
                            "flex items-center gap-2.5 w-full px-2.5 py-1.5 rounded-lg text-sm transition-all duration-200 text-left",
                            isActive
                              ? "bg-sidebar-primary text-sidebar-primary-foreground font-medium shadow-sm"
                              : "hover:bg-sidebar-accent hover:text-sidebar-foreground text-sidebar-foreground/70"
                          )}
